...
const PublicHealth = () => {
  ...
  return (
    <>
      <Breadcrumb
        pageName="Public Health Solution"
        description="Bridging Gaps in Public Healthcare. Delivering Tailored Solutions to Improve Access and Quality of Care in Underserved Communities with Healthvalors Technologies."
      />
                ...
                >
                  <div className="mx-[-12px] flex flex-wrap">
                    ...
                    <div className="xl:w-fulll w-full px-3 sm:w-1/2 lg:w-full">
                      <List
                        text="
People in Public areas generally have less access to healthcare than their urban counterparts.
"
                      />
                      <List text="700 million people living in 636k villages." />
                      <List text="66% of Public Indians don’t have access to critical medicine." />
                      <List text="31% of the population travel more than 30 kms seeking health care in Public India." />
